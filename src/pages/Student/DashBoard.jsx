...
const DashBoard = () => {
  ...
  const recommendedCourses = Array(4)
    .fill(null)
    .map((_, index) => ({
      id: `rec-${index + 1}`,
              ...
              <div className="relative">
                ...
                <div className="absolute top-3 right-3 flex flex-col gap-2">
                  ...
                  >
                    <Heart
                      size={16}
                      className={course.isFavorite ? "fill-white" : ""}
                    />
                  </button>
                  <button
                    className={`w-8 h-8 rounded-full flex items-center justify-center shadow-lg transition-colors ${
                  ...
                  >
                    <Bookmark
                      size={16}
                      className={course.isBookmarked ? "fill-white" : ""}
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="p-5">
                ...
                <div className="space-y-2 text-sm mb-4">
                  ...
                  <p>
                    ...
                    <span className="text-cyan-600">{course.price}</span>
                  </p>
                  <p>
