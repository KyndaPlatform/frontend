    ...
    <nav className="bg-white border-b border-gray-200 px-4 py-3">
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 px-4 py-3 text-blue-600 bg-[#F1F5F9] border border-blue-200 rounded-full hover:bg-blue-50 transition-colors cursor-pointer">
            {/* <Sparkles size={18} /> */}
            <img src={sparkle} />
          ...
          <div className="relative" ref={notificationRef}>
            <button
              ...
              className="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors relative cursor-pointer"
            >
              <Bell size={22} />
